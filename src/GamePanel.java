...
public class GamePanel extends JPanel{
	...
	public GamePanel(int startLevel, int startHeight) {
	...
	public void init(int startLevel, int startHeight) {
		...
		thePiece = new Piece();
		theGrid = new Grid(startHeight);
		theHUD = new HUD(startLevel);
		
		
		image = new BufferedImage(DanTetrisMain.WIDTH, DanTetrisMain.HEIGHT, BufferedImage.TYPE_INT_RGB);
	...
	public void play() {
		playSound("file:./Resources/Type A.wav", 63);
		while(running) {
	...
	public void draw() {
		...
		g.setColor(new Color(theHUD.getLevel() * 8,0,(255 - (theHUD.getLevel() * 8))));
		g.fillRect(0,0,DanTetrisMain.WIDTH,DanTetrisMain.HEIGHT);
	...
	public void paintComponent(Graphics g) {
		...
		g2.drawImage(image, 0, 0, DanTetrisMain.WIDTH, DanTetrisMain.HEIGHT, null);
